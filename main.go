...
var img, _ = tex.ReadImage("./resources/gato.png")
var player = geo.NewRect(1, 1, vec.NewVec2D(6, 6)).
...
var sqr = geo.NewRect(20, 20, vec.NewVec2D(150, 150))
...
var win = window.New(vec.NewVec2D(0, 0), vec.NewVec2D(12, 12))
...
func Update(ctx *ebiten.Image) {
	...
	transform.RotateVerticesOnPivot(6, vec.NewVec2D(Height/2, Width/2), sqr)
}
